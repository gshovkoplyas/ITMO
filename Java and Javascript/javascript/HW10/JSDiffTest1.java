...
public class JSDiffTest1 {
    ...
    public static void main(String[] args) throws ScriptException, IOException {
        ...
        new JSDiffTest1(verbose, easy).run();
    }

    private boolean verbose;
    private boolean easy;

    public JSDiffTest1(boolean verbose, boolean easy) {
    ...
    private IO run(String script) {
        ...
        try {
            ...
            engine.eval(new InputStreamReader(new FileInputStream("jsdiff_speed_diff.js"), "UTF-8"));
            engine.eval(script);
        } catch (Exception e) {
