		...
		if (tree->left != NULL)
		{
			...
			if (bench->data > bench->parent->data)
			{
				if (bench->left == NULL)
					...
					bench->parent->right = bench->left, bench->left->parent = bench->parent;
			}
			else
			{
				if (bench->left == NULL)
					...
					bench->parent->left = bench->left, bench->left->parent = bench->parent;
			}
		...
		else
		{
			...
			if (bench->data > bench->parent->data)
			{
				if (bench->right == NULL)
					...
					bench->parent->right = bench->right, bench->right->parent = bench->parent;
			}
			else
			{
				if (bench->right == NULL)
					...
					bench->parent->left = bench->right, bench->right->parent = bench->parent;
			}
			tree->data = bench->data;
			delete bench;
		}
