...
public interface PascalVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link PascalParser#eval}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEval(PascalParser.EvalContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#programStart}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProgramStart(PascalParser.ProgramStartContext ctx);
	/**
